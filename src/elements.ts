...
// answers it with a Phoenix; Ash and Rainbow have four; Chick, White Light,
// Cloud and Sand three; Bird, Charcoal, Diamond, Dog, Fire, Lizard, Night,
...
// n is OPTIONAL in the table below: for 85 of the 89 it is just the id with a
...
export const ELEMENTS = ([
  ...
  // unchanged.
  { id:"night", c:"#8a56e0", q:"The sky, resting.",
  ...
  { id:"charcoal", c:"#8a3a14", q:"Black as charcoal, cold as ash.",
  ...
  { id:"ash", c:"#b9b3ad", q:"What is left when even the burning is done.",
